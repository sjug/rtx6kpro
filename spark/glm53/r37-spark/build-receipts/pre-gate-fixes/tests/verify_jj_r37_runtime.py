#!/usr/bin/env python3
"""Verify the JJ r37 Spark source, native, and SM121 runtime contract."""
...
def main() -> None:
    ...
    verify_manifest(
        json.loads(Path("/opt/local-inference/r37-native-manifest.json").read_text()),
        native_manifest(),
    )
    ...
    # R37 source markers: widened scalar restore, leading-instruction
    ...
    print("R37 caller-owned Q output numerical regression: PASS", flush=True)
    ...
    print("JJ r37 Spark runtime contract: PASS")
