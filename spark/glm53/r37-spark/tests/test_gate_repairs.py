#!/usr/bin/env python3
"""Offline regressions for the rejected R37 build and prune exposure."""
...
class GateRepairs(unittest.TestCase):
    ...
    def test_collection_precedes_gpu_execution(self):
        ...
        self.assertLess(source.index("gate-regressions.sh collect"), source.index("/verify_jj_r37_runtime.py"))
    ...
    def test_lmcache_selection_imports_the_installed_distribution(self):
        ...
        self.assertIn("cd /opt/lmcache/source-r37", lines)
