...
directory = "/opt/local-inference/r37-native/flashkda-tests"
...
if args.collect_only_count:
    ...
    print("FLASHKDA-R37-COLLECTION-OK collected=12", flush=True)
else:
    matrix.verify(code)
    print("FLASHKDA-R37-GATE-OK collected=12 passed=12 skipped=0", flush=True)
