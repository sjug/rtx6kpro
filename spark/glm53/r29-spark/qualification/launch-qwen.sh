#!/usr/bin/env bash
# Only dusty/kirby Qwen. Preserve R28 rollback containers and all model/JIT caches.
set -euo pipefail
...
runner=/home/jugs/git/bld-jj-r29-spark/run-qwen38-flash-next-jj-r29-spark-tp2-node.sh
name=qwen38-flash-next-nvfp4-jj-r29-tp2
