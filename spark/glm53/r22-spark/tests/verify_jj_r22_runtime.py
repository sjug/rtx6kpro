#!/usr/bin/env python3
"""Verify the JJ r22 Spark source, native, and SM121 runtime contract."""
...
def main() -> None:
    ...
    # This GLM candidate intentionally carries R22's fill-elided packed MXFP8
    # path plus the persistent-store correction, not Qwen r15p's empirical
    # allocation touch. Qwen therefore remains outside this image's scope.
    ...
    print("JJ r22 Spark runtime contract: PASS")
