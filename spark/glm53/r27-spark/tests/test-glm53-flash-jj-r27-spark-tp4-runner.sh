...
runner=${1:-"$(dirname "$0")/../run-glm53-flash-jj-r27-spark-tp4-node.sh"}
...
require "${stop_render}" 'podman stop -t 60 glm53-flash-nvfp4-jj-r27-spark-tp4'
...
echo 'GLM-5.3 Flash NVFP4 JJ r27 Spark TP4 runner: PASS'
