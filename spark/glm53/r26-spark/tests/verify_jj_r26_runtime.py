#!/usr/bin/env python3
"""Verify the JJ r26 Spark source, native, and SM121 runtime contract."""
...
def main() -> None:
    ...
    # R26 carries the fill-elided packed MXFP8 path plus the persistent-store
    # correction that superseded Qwen r15p's empirical allocation touch.
    ...
    print("JJ r26 Spark runtime contract: PASS")
