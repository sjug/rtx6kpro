#!/usr/bin/env python3
"""Verify the JJ r28 Spark source, native, and SM121 runtime contract."""
...
def main() -> None:
    ...
    # B12X invariants carried from r26 plus the r28 loader sources, which stay
    ...
    print("JJ r28 Spark runtime contract: PASS")
