#!/usr/bin/env python3
"""Verify the JJ r32 Spark source, native, and SM121 runtime contract."""
...
def main() -> None:
    ...
    verify_manifest(
        json.loads(Path("/opt/local-inference/r32-native-manifest.json").read_text()),
        native_manifest(),
    )
    ...
    # R32 source markers: widened scalar restore, leading-instruction
    ...
    # B12X invariants and loader sources retained byte-identically from R29, staying
    ...
    print("R32 caller-owned Q output numerical regression: PASS", flush=True)
    ...
    print("JJ r32 Spark runtime contract: PASS")
