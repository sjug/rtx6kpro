...
export IMAGE="${IMAGE:-voipmonitor/vllm:gilded-gnosis-v20p0-ds4-spark-sm121-vllm2167295-si6a92bcc-fi801d57a-cu132-${DATE_TAG}}"
...
export VLLM_BUILD_VERSION="${VLLM_BUILD_VERSION:-0.11.2.dev281+gilded.gnosis.v20p0.ds4.vllm2167295.si6a92bcc.fi801d57a.sm121.cu132.${DATE_TAG}}"
...
FLASHINFER_WHEEL_STASH=".tmp-flashinfer-wheels.disabled-gg-v20p0-spark-${DATE_TAG}"
