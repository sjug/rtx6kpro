...
# GLM-5.2 v17 hybrid four-node TP4 launcher for the DGX Spark cluster
...
# serve-glm52-v16.sh / serve-glm52-hybrid-v17.sh have no EXTRA_VLLM_ARGS
...
# a faithful copy of the helper at vLLM v17 @ 6ccc3eb with the hybrid
...
IMAGE=${IMAGE:-localhost/voipmonitor/vllm:fathomless-firmament-v17-spark-sm121-vllm6ccc3eb-b12x1377d5f-fi801d57a-cu132-20260714}
NAME=${NAME:-glm52-v17-tp4}
PORT=${PORT:-8000}
NNODES=${NNODES:-4}
...
CACHE=${CACHE:-$HOME/.cache/vllm-glm52-v17}
...
QUANT_CONFIG='{"linear":{"weight":"mxfp8"},"ignore":["re:.*kv_b_proj"]}'
